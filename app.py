...
def edit(initiative_id):
    ...
    all_goods = mongo.db.goods_services.find()
    return render_template("editanimal.html", initiative=the_initiative, 
                            types=all_initiative_types, goods=all_goods)
